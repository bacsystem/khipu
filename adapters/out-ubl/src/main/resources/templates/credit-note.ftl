...
<CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2"
  ...
  <#-- Motivo (catálogo 09; reglas 2128, 2172, 2135) y comprobante que se modifica (cac:BillingReference; reglas 2524, 2117, 2116). -->
  <cac:DiscrepancyResponse>
    <cbc:ReferenceID>${c.nota().documentoAfectado()}</cbc:ReferenceID>
    <cbc:ResponseCode listAgencyName="PE:SUNAT" listName="Tipo de nota de credito" listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo09">${c.nota().motivo()}</cbc:ResponseCode>
...
<@u.lineas elemento="CreditNoteLine" cantidad="CreditedQuantity"/>
</CreditNote>
