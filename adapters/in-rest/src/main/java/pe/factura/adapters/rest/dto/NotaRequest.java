...
public record NotaRequest(
        ...
        @Valid @Schema(description = "Ítems que cubre la nota, con el mismo formato que en la factura. **Omítalos** para una nota total: khipu copia los ítems, el descuento global y los cargos de la factura (anulación, devolución total)") List<FacturaRequest.ItemDto> items,
        @Valid @Schema(description = "Descuento global de la nota (solo con `items`)") FacturaRequest.DescuentoDto descuentoGlobal,
        @Valid @Schema(description = "Cargos globales de la nota (solo con `items`)") List<FacturaRequest.CargoDto> cargos,
