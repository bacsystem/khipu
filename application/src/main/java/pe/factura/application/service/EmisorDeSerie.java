...
final class EmisorDeSerie {
    ...
    static Tenant paraEmitir(EstablecimientoRepository establecimientos, Tenant t, Comprobante c) {
        return establecimientos.buscarAsignacionDeSerie(t.id(), c.tipo(), c.serie()).map(a -> {
    ...
    static Tenant paraImprimir(EstablecimientoRepository establecimientos, Tenant t, Comprobante c) {
        return establecimientos.buscarAsignacionDeSerie(t.id(), c.tipo(), c.serie())
