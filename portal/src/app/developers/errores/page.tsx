...
const CODIGOS: Array<[string, string, string, string]> = [
  ...
  ["AFECTACION_INVALIDA", "422", "Comprobante afecto al IVAP (afectación 17, arroz pilado) con ítems de otra afectación (10/20/30 o gratuitas), o una línea IVAP con ISC o ICBPER (2650, 3223).", "Emita el comprobante IVAP solo con ítems `17` y sin `isc` ni `icbper`; las demás ventas van en otro comprobante."],
