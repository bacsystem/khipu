 ...
 * como {@code cac:PartyName/cbc:Name} del emisor cuando existe.
 */
public record Tenant(UUID id, String ruc, String razonSocial, Entorno entorno, CredencialesSol sol, CertificadoDigital certificado,
    ...
    public Tenant(UUID id, String ruc, String razonSocial, Entorno entorno, CredencialesSol sol, CertificadoDigital certificado,
        ...
        this(id, ruc, razonSocial, entorno, sol, certificado, domicilio, cuentaDetracciones, null);
    }
    public Tenant(UUID id, String ruc, String razonSocial, Entorno entorno, CredencialesSol sol, CertificadoDigital certificado) {
        this(id, ruc, razonSocial, entorno, sol, certificado, null, null, null);
    }
    ...
    public Tenant conCertificado(CertificadoDigital c) { return new Tenant(id, ruc, razonSocial, entorno, sol, c, domicilio, cuentaDetracciones, nombreComercial); }
    public Tenant conCredencialesSol(CredencialesSol s) { return new Tenant(id, ruc, razonSocial, entorno, s, certificado, domicilio, cuentaDetracciones, nombreComercial); }
    ...
    public Tenant conDatosFiscales(Domicilio d, String cuentaDetracciones, String nombreComercial) { return new Tenant(id, ruc, razonSocial, entorno, sol, certificado, d, cuentaDetracciones, nombreComercial); }
}
