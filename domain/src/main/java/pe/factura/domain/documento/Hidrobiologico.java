 ...
 * SUNAT los exige todos en cada línea (3063, 3130–3135) y observa los formatos (4280/4281).
 */
public record Hidrobiologico(String matricula, String nombreEmbarcacion, String especie, String lugarDescarga, LocalDate fechaDescarga, BigDecimal cantidad) {
    public Hidrobiologico {
        matricula = texto(matricula, "matricula", 15, "3063");
        nombreEmbarcacion = texto(nombreEmbarcacion, "nombre_embarcacion", 100, "3130");
        especie = texto(especie, "especie", 150, "3131");
        lugarDescarga = texto(lugarDescarga, "lugar_descarga", 100, "3132");
    ...
    private static String texto(String v, String campo, int max, String regla) {
